        ...
        <div className="flex justify-center mb-6">
            <Tabs defaultValue={activePlatform || "all"} onValueChange={handlePlatformChange} className="w-full max-w-md">
                <TabsList className="grid grid-cols-4 w-full">
                    <TabsTrigger value="all" className="flex cursor-pointer items-center gap-1">
                        All
                    </TabsTrigger>
                    <TabsTrigger value="codeforces" className="flex cursor-pointer items-center gap-1">
                        <Code2 className="h-4 w-4" />
                        <span className="hidden sm:inline">Codeforces</span>
                    </TabsTrigger>
                    <TabsTrigger value="codechef" className="flex cursor-pointer items-center gap-1">
                        <Code className="h-4 w-4" />
                        <span className="hidden sm:inline">CodeChef</span>
                    </TabsTrigger>
                    <TabsTrigger value="leetcode" className="flex cursor-pointer items-center gap-1">
